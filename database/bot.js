...
global.pemilik = ['27634090203'] 
global.premium = ['27634090203'] 
global.pengguna = 'sacole' 
global.footer = 'ZIM BOT INC'
global.botnma = 'ZIM BOT INC' 
global.botname = 'ZIM BOT V4'
global.ownernma = 'sacole' 
global.packname = 'sacole' 
global.author = 'By sacole Memes' 
global.sessionName = 'session' 
global.prefa = ['#','!','/',''] 
global.sp = '🔵' 
global.sacoletyping = false
global.sacolereadgroup = false
global.sacolereadall = false
global.sacolerecord = false
global.available = false
global.unavailable = true
global.limittot = 100,
global.thumb = fs.readFileSync('./src/logo.jpg')
global.reactmoji = '⚡'
global.imgjoinrpg = fs.readFileSync('./src/joinrpg.jpg')
global.imgmining = fs.readFileSync('./src/mining.jpg')
global.imgdevil = fs.readFileSync('./src/img/devil.jpg')
global.imgslime = fs.readFileSync('./src/img/slime.jpg')
global.imgdemon = fs.readFileSync('./src/img/demon.jpg')
global.imggoblin = fs.readFileSync('./src/img/goblin.jpg')
global.imgdemonking = fs.readFileSync('./src/img/demonking.jpg')
global.imgbehemoth = fs.readFileSync('./src/img/behemoth.jpg')
...
global.thumb = fs.readFileSync('./src/sacole.jpg')
